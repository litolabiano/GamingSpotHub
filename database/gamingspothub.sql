...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 07:31 AM
...
(50, 17, 2, 'hourly', 90, '2026-04-21 08:39:58', NULL, NULL, 80.00, NULL, 'active', NULL, 12, '2026-04-21 08:39:58');
...
--
ALTER TABLE `reservations`
  MODIFY `reservation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
