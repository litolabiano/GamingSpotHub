...
(105, 'DualSense', 0, 'controller', '2026-05-08 09:09:20'),
(106, 'DualShock 4', 0, 'controller', '2026-05-08 09:09:20'),
(107, 'Xbox Controller', 0, 'controller', '2026-05-08 09:09:20'),
...
--
ALTER TABLE `console_types`
  MODIFY `type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
...
--
ALTER TABLE `reservation_cancellations`
  MODIFY `cancel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `reservation_reschedules`
--
ALTER TABLE `reservation_reschedules`
  MODIFY `reschedule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
